...
const DATA = {
  ...
  matches: [
    ...
    { id:84, phase:'dieciseisavos', nextId:94, slot:'away', home:'España', homeFlag:'🇪🇸', fav:'80%', away:'Austria', awayFlag:'🇦🇹', homeScore:0, awayScore:0, status:'live', date:'02 Jul', time:'13:00', venue:'Estadio Los Ángeles' },
