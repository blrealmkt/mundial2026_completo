...
const DATA = {
  ...
  matches: [
    ...
    { id:77, phase:'dieciseisavos', nextId:91, slot:'home', home:'Francia', homeFlag:'🇫🇷', fav:'80%', away:'Suecia', awayFlag:'🇸🇪', homeScore:1, awayScore:0, status:'live', date:'30 Jun', time:'15:00', venue:'Estadio Nueva York' },
