...
const DATA = {
  ...
  matches: [
    ...
    { id:74, phase:'dieciseisavos', nextId:89, slot:'away', home:'Alemania', homeFlag:'🇩🇪', fav:'75%', away:'Paraguay', awayFlag:'🇵🇾', homeScore:1, awayScore:2(penalties 3-4), status:'done', date:'29 Jun', time:'14:30', venue:'Estadio Boston' },
