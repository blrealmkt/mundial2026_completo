...
const DATA = {
  ...
  currentWeek: { startDate: '12 Jul', endDate: '19 Jul', label: 'Semana del 12 al 19 de julio' },
  ...
  matches: [
    ...
    { id:89, phase:'octavos', group:null,
      ...
      homeScore:0, awayScore:3, date:'04 Jul', time:'11:00', venue:'Estadio Filadelfia', status:'done' },
    ...
    { id:92, phase:'octavos', group:null,
      ...
      homeScore:2, awayScore:3, date:'05 Jul', time:'19:00', venue:'Estadio Ciudad de México', status:'done' },
    { id:93, phase:'octavos', group:null,
      home:'Portugal', homeFlag:'🇵🇹', away:'España', awayFlag:'🇪🇸',
      homeScore:0, awayScore:1, date:'06 Jul', time:'13:00', venue:'Estadio Dallas', status:'done' },
    { id:94, phase:'octavos', group:null,
      home:'Estados Unidos', homeFlag:'🇺🇸', away:'Bélgica', awayFlag:'🇧🇪',
      homeScore:1, awayScore:4, date:'06 Jul', time:'18:00', venue:'Estadio Seattle', status:'done' },
    ...
    { id:99,  phase:'cuartos', group:null,
      ...
      homeScore:2, awayScore:1, date:'11 Jul', time:'15:00', venue:'Hard Rock Stadium, Miami', status:'done' },
    { id:100, phase:'cuartos', group:null,
      home:'Argentina', homeFlag:'🇦🇷', away:'Suiza', awayFlag:'🇨🇭',
      homeScore:3, awayScore:1, date:'11 Jul', time:'19:00', venue:'Arrowhead Stadium, Kansas City', status:'done' },
    // ── SEMIFINALES
    ...
    { id:103, phase:'semis', group:null,
      ...
      homeScore:4, awayScore:6, date:'18 Jul', time:'15:00', venue:'Hard Rock Stadium, Miami', status:'done' },
    // ── GRAN FINAL
    { id:104, phase:'final', group:null,
      home:'España', homeFlag:'🇪🇸', away:'Argentina', awayFlag:'🇦🇷',
      homeScore:1, awayScore:0, date:'19 Jul', time:'13:00', venue:'Estadio Nueva York', status:'done' },
  ],
  ...
  scorers: [
    // ── 10 goles
    { name:'Kylian Mbappé', team:'Francia', flag:'🇫🇷', goals:10, highlight:true },
    // ── 8 goles
    { name:'Lionel Messi', team:'Argentina', flag:'🇦🇷', goals:8, highlight:true },
    // ── 7 goles
    { name:'Jude Bellingham', team:'Inglaterra', flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿', goals:7, highlight:true },
    { name:'Erling Haaland', team:'Noruega', flag:'🇳🇴', goals:7, highlight:true },
    // ── 6 goles
    { name:'Harry Kane', team:'Inglaterra', flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿', goals:6 },
    { name:'Ousmane Dembélé', team:'Francia', flag:'🇫🇷', goals:6 },
        // ── 5 goles
   ...
   // ── 4 goles
    ...
    { name:'Lautaro Martínez', team:'Argentina', flag:'🇦🇷', goals:3 },
    { name:'Bradley Barcola', team:'Francia', flag:'🇫🇷', goals:3 },
    { name:'Bukayo Saka', team:'Inglaterra', flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿', goals:3 },
    ...
    { name:'Raúl Jiménez', team:'México', flag:'🇲🇽', goals:3 },
...
(function() {
  const SIMULATOR_DATA = [
    ...
    { id:91, logicalId:19, phase:'octavos', nextId:98, slot:'home', home:'Portugal', homeFlag:'🇵🇹', away:'España', awayFlag:'🇪🇸', homeScore:0, awayScore:1, status:'done', locked:true, date:'06 Jul' },
    { id:92, logicalId:20, phase:'octavos', nextId:98, slot:'away', home:'Estados Unidos', homeFlag:'🇺🇸', away:'Bélgica', awayFlag:'🇧🇪', homeScore:0, awayScore:1, status:'done', locked:true, date:'06 Jul' },
    ...
    { id:94, logicalId:22, phase:'octavos', nextId:99, slot:'away', home:'México', homeFlag:'🇲🇽', away:'Inglaterra', awayFlag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿', homeScore:0, awayScore:1, status:'done', locked:true, date:'05 Jul' },
    { id:95, logicalId:23, phase:'octavos', nextId:100, slot:'home', home:'Argentina', homeFlag:'🇦🇷', away:'Egipto', awayFlag:'🇪🇬', homeScore:1, awayScore:0, status:'done', locked:true, date:'07 Jul' },
    ...
    { id:99, logicalId:27, phase:'cuartos', nextId:102, slot:'home', home:'Noruega', homeFlag:'🇳🇴', away:'Inglaterra', awayFlag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿', homeScore:0, awayScore:1, status:'done', locked:true, date:'11 Jul' },
    ...
    { id:102, logicalId:30, phase:'semis', nextId:104, slot:'away', home:'Inglaterra', homeFlag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿', away:'Argentina', awayFlag:'🇦🇷', homeScore:0, awayScore:1, status:'done', locked:true, date:'15 Jul' },
    
    // ── TERCER LUGAR (M31) Y FINAL (M32) ──
    { id:103, logicalId:31, phase:'tercer-lugar', nextId:null, slot:null, home:'Francia', homeFlag:'🇫🇷', away:'Perdedor M30', awayFlag:'🥉', homeScore:0, awayScore:1, status:'done', locked:true, date:'18 Jul' },
    { id:104, logicalId:32, phase:'final', nextId:null, slot:null, home:'España', homeFlag:'🇪🇸', away:'Finalista 2', awayFlag:'🌍', homeScore:1, awayScore:0, status:'done', locked:true, date:'19 Jul' }
  ];
