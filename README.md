...
const DATA = {
  ...
  matches: [
    ...
    { id:75, phase:'dieciseisavos', nextId:90, slot:'home', home:'Países Bajos', homeFlag:'🇳🇱', fav:'50%', away:'Marruecos', awayFlag:'🇲🇦', homeScore:1, awayScore:0, status:'live', date:'29 Jun', time:'19:00', venue:'Estadio Monterrey' },
    ...
    { id:89, phase:'octavos', group:null,
      home:'Canadá', homeFlag:'🇨🇦', away:'pendiente', awayFlag:'⭐',
    ...
    { id:90, phase:'octavos', group:null,
      home:'Paraguay', homeFlag:'🇵🇾', away:'pendiente', awayFlag:'🏆',
    ...
    { id:91, phase:'octavos', group:null,
      home:'Brasil', homeFlag:'🇧🇷', away:'pendiente', awayFlag:'🥈',
    ...
    { id:92, phase:'octavos', group:null,
      ...
      homeScore:null, awayScore:null, date:'05 Jul', time:'14:00', venue:'Estadio Ciudad de México', status:'scheduled' },
  ...
  scorers: [
    ...
    // ── 3 goles
    { name:'Jonathan David', team:'Canadá', flag:'🇨🇦', goals:3, highlight:true },
    { name:'Harry Kane', team:'Inglaterra', flag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿', goals:3, highlight:true },
    { name:'Matheus Cunha', team:'Brasil', flag:'🇧🇷', goals:3, highlight:true },
    { name:'Johan Manzambi', team:'Suiza', flag:'🇨🇭', goals:3, highlight:true },
    { name:'Ismael Saibari', team:'Marruecos', flag:'🇲🇦', goals:3, highlight:true },
    { name:'Ismaïla Sarr', team:'Senegal', flag:'🇸🇳', goals:3, highlight:true },
    { name:'Brian Brobbey', team:'Países Bajos', flag:'🇳🇱', goals:3, highlight:true },
...
function showView(id) {
  ...
  if (id === 'quiniela' && window.qnInit) window.qnInit();
}
...
(function() {
  const SIMULATOR_DATA = [
    ...
    { id:74, phase:'dieciseisavos', nextId:89, slot:'away', home:'Alemania', homeFlag:'🇩🇪', fav:'75%', away:'Paraguay', awayFlag:'🇵🇾', homeScore:0, awayScore:1, status:'done', date:'29 Jun' },
    ...
    { id:76, phase:'dieciseisavos', nextId:90, slot:'away', home:'Brasil', homeFlag:'🇧🇷', fav:'65%', away:'Japón', awayFlag:'🇯🇵', homeScore:1, awayScore:0, status:'done', date:'29 Jun' },
